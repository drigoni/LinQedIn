...
{
public:
    ExecutiveUser(const QString&,const QString&,const QString&,const QString&); //crea l'utente avente Nome,Cognome,Email,Password
    ExecutiveUser(const QString&, UserContactsNetwork*,UserBaseInformations*); //crea l'utente passando Email,ReteAmicizie,Profilo
