...
class FreeUser: public AUser
{
public:
    FreeUser(const QString&,const QString&,const QString&,const QString&); //crea l'utente avente Nome,Cognome,Email,Password
    FreeUser(const QString&,UserContactsNetwork*, UserBaseInformations*); //crea l'utente passando Email,ReteAmicizie,Profilo
